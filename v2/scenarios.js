...
const round1Scenarios = [
  ...
  {
    id: 'inheritance',
    title: 'THE BUDGET COMMITMENT',
    subtitle: 'Week 3 - Q1',
    month: 1,
    quarter: 1,
    description: `**WEEK 3 IN ROLE:** You've just discovered your predecessor committed to the Board that Q1 would deliver three major initiatives:
...
**The Problem:** Your CFO just informed you there's only budget for TWO of these (£8M available, need £12M for all three). Your predecessor over-promised.

**The Politics:**
• Marketing Director (close to CEO): "Marketing is non-negotiable - Board expects it"
• HR Director (your ally): "Training is essential - we're hemorrhaging talent"
• Sales Director (skeptical of you): "Dealer relationships are deteriorating - this is urgent"

**The Complication:** Board update in 2 weeks. They're expecting all three. Which do you cut AND how do you explain it?`,
        ...
        decisions: [
            {
                ...
                type: 'choice',
                options: [
                    { text: 'A) Cut the Marketing Campaign (keep Training + Dealer relationships)', style: 'coaching', color: 'GREEN' },
                    { text: 'B) Cut the Training Program (keep Marketing + Dealer relationships)', style: 'pacesetting', color: 'RED' },
                    { text: 'C) Cut the Dealer Network Overhaul (keep Marketing + Training)', style: 'pacesetting', color: 'BLUE' },
                    { text: 'D) Try to partially fund all three (£8M split 3 ways = £2.67M each)', style: 'affiliative', color: 'YELLOW' },
                    { text: 'E) Request additional budget approval from CFO', style: 'democratic', color: 'YELLOW' }
                ]
            },
            {
            ...
            },  
            {
                ...
                type: 'choice',
                options: [
                    { text: 'Detailed presentation with data and rationale', style: 'pacesetting', color: 'BLUE' },
                    { text: 'Open forum discussion on implementation', style: 'democratic', color: 'YELLOW' },
...
additionalInfo: [
  ...
  },
  {
    ...
    type: 'trap',
    content: 'Shows impressive campaign metrics but fails to mention that last year\'s campaign didn\'t translate to sales growth. Designed to make you think marketing is essential.',
...
// SCENARIO 2: THE DATA DILEMMA
{
  ...
  **Marketing Report:** "Customer satisfaction at all-time high (92% positive sentiment)"
  
  **Operations Report:** "Service complaints up 35% this quarter, response times deteriorating"
  
  Both teams defend their data methodology. Your CFO is confused. Board meeting in 48 hours wants clarity on customer health.`,
  ...
  decisions: [
    {
      ...
      type: 'choice',
      options: [
        { text: 'Deep dive into both methodologies to find the disconnect', style: 'pacesetting', color: 'BLUE' },
        { text: 'Make immediate decision based on business priorities - no time for debate', style: 'coercive', color: 'YELLOW' },
        { text: 'Convene joint meeting with both teams to debate findings', style: 'democratic', color: 'YELLOW' },
        { text: 'Trust the metric most aligned to business outcomes (satisfaction)', style: 'coercive', color: 'RED' }
      ]
    },
    {
      title: 'Part 2: You discover both are technically correct - Marketing surveys loyal customers, Operations tracks all complaints including new segments. How do you present to the Board?',
      type: 'choice',
      options: [
  ...
  additionalInfo: [
    {
      ...
      type: 'useful',
      content: 'Surveys sent to customers who purchased in last 12 months - skews to loyal base'
    },
    {
      label: 'Operations complaint data',
      type: 'useful',
      content: 'Tracks all inquiries including new customer segments with different expectations'
    },
    {
      label: 'CFO perspective',
      type: 'trap',
      content: 'Wants simple answer for Board, encourages oversimplification'
    }
  ],
...
// SCENARIO 3: THE SAFETY CRISIS
{
  ...
  month: 3,
  quarter: 1,
  description: `A near-miss safety incident occurred at your main distribution facility involving a Telescopic Handler. No injuries, but HSE regulations were nearly breached.

**The Finger-Pointing:**
• Operations Director: "Suspend the employee pending investigation - we need to protect the company from liability"
• HR Director: "This is a training gap - we need immediate retraining (£15k, 2 days downtime)"
• Safety Officer: "Conduct facility-wide safety audit before resuming operations (£85k, 1 week downtime)"

**The Pressure:** HSE inspector is visiting next week. If you do nothing and another incident occurs, regulatory consequences could be severe. But overreacting could damage team morale and delay Q1 targets.
   ...
   decisions: [
        {
            ...
            type: 'choice',
            options: [
                { text: 'A) Suspend employee pending investigation (HR recommendation)', style: 'coercive', color: 'RED' },
                { text: 'B) Immediate retraining for employee and team (£15k, 2 days)', style: 'coaching', color: 'GREEN' },
                { text: 'C) Facility-wide safety audit (£85k, 1 week downtime)', style: 'authoritative', color: 'BLUE' },
                { text: 'D) Issue safety reminder and continue operations (zero cost)', style: 'affiliative', color: 'YELLOW' },
                { text: 'E) Investigate root cause first, then decide (1 week)', style: 'democratic', color: 'YELLOW' }
            ]
        },
        {
            ...
            type: 'choice',
            options: [
                { text: 'A) Firm warning about safety standards and consequences', style: 'coercive', color: 'RED' },
                { text: 'B) Frame as learning opportunity - "Let\'s use this to improve"', style: 'coaching', color: 'GREEN' },
                { text: 'C) Empathetic approach - "We\'re all in this together"', style: 'affiliative', color: 'YELLOW' },
                { text: 'D) Set clear expectations - "Excellence in safety is non-negotiable"', style: 'pacesetting', color: 'RED' },
                { text: 'E) Facilitated discussion - "What can WE do to prevent this?"', style: 'democratic', color: 'YELLOW' }
            ]
        }
    ],
    ...
    additionalInfo: [
        {
            ...
            type: 'useful',
            content: 'This is the first incident in 3 years - suggests systemic issue, not individual fault. Strong safety culture historically.',
            validatesDecision: [1, 4] // Validates retraining or investigation (choices B, E)
        },
        {
            label: 'Speak with employee involved',
            type: 'useful',
            content: 'Reveals training gap in new equipment protocols introduced 2 months ago. Employee had only 1 day training vs recommended 3 days.',
            validatesDecision: [1] // Validates retraining (choice B)
        },
        {
            label: 'Legal team memo on liability',
            type: 'trap',
            content: 'Emphasizes CYA discipline approach, creates fear culture. Recommends immediate suspension to "protect the company."',
  ...
  decisions: [
    {
      ...
      type: 'choice',
      options: [
        { text: 'Make reasonable assumptions based on experience and act decisively', style: 'authoritative', color: 'RED' },
        { text: 'Invest time to gather comprehensive data systematically', style: 'authoritative', color: 'BLUE' },
        { text: 'Consult with wider stakeholder group (dealers, customers, team)', style: 'democratic', color: 'YELLOW' },
        { text: 'Run small experiments in different regions to test theories', style: 'democratic', color: 'GREEN' }
      ]
    },
    {
      title: 'Part 2: After investigation, you discover ALL THREE theories are partially true. What\'s your approach?',
      type: 'choice',
      options: [
        { text: 'Focus resources on the biggest factor (competitor feature)', style: 'authoritative', color: 'BLUE' },
        { text: 'Address all three simultaneously with integrated strategy', style: 'democratic', color: 'YELLOW' },
        { text: 'Test different approaches in different regions to learn', style: 'democratic', color: 'GREEN' },
        { text: 'Make decisive call on root cause based on judgment', style: 'pacesetting', color: 'RED' }
      ]
    },
    {
      title: 'Part 3: The situation remains ambiguous even after analysis. How do you move forward?',
      type: 'choice',
      options: [
        { text: 'Make executive decision and commit to it fully', style: 'authoritative', color: 'GREEN' },
        { text: 'Commit to a direction and give it 90 days before reassessing', style: 'authoritative', color: 'BLUE' },
        { text: 'Continue gathering data until picture is clearer', style: 'affiliative', color: 'YELLOW' },
        { text: 'Trust my instincts and act now', style: 'pacesetting', color: 'RED' }
      ]
    }
  ],
  ...
  additionalInfo: [
    {
      ...
      type: 'useful',
      content: 'Mixed signals - some mention competitor, some mention economy, some say "you stopped asking us what we need"'
    },
    {
      label: 'Competitor intelligence report',
      type: 'trap',
      content: 'Exaggerates competitor threat, creates pressure to react hastily'
    },
    {
      label: 'Your team\'s perspective',
      type: 'useful',
      content: 'Frontline staff notice customers feel rushed, less consultative conversations'
    }
  ],
   ...
   decisions: [
    ...
    },
    {
      ...
      options: [
        ...
        { text: '"We\'re strongest when we support each other - let\'s unite as one team"', style: 'affiliative', color: 'YELLOW' }
      ]
    }
  ],
  ...
  decisions: [
    {
      ...
      type: 'choice',
      options: [
        { text: 'External factors (compensation, market conditions, etc.)', impact: 'external', style: 'authoritative', color: 'BLUE' },
        { text: 'My leadership approach isn\'t working - I need to change', impact: 'selfaware', style: 'coaching', color: 'GREEN' },
        { text: 'Team needs more support and development opportunities', impact: 'development', style: 'coaching', color: 'GREEN' },
        { text: 'Some people just aren\'t cut out for this level - replace them', impact: 'harsh', style: 'coercive', color: 'RED' }
      ]
    },
    {
      ...
      options: [
        ...
        { text: 'Individual performance warnings for underperformers', style: 'coercive', color: 'GREEN' },
...
// SCENARIO 7: THE DIFFICULT CONVERSATION
{
  ...
  decisions: [
    {
      ...
      type: 'choice',
      options: [
        { text: 'Document performance issues formally with HR', style: 'authoritative', color: 'BLUE' },
        { text: 'Seek to understand their perspective first', style: 'coaching', color: 'GREEN' },
        { text: 'Practice the difficult conversation with a trusted advisor', style: 'democratic', color: 'YELLOW' },
        { text: 'Focus on outcomes and clear expectations', style: 'pacesetting', color: 'RED' }
      ]
    },
    {
      title: 'Part 2: During the conversation, they become emotional and defensive. You:',
      type: 'choice',
      options: [
        { text: 'Stay firm on performance expectations', style: 'coercive', color: 'RED' },
        { text: 'Acknowledge their feelings, then refocus on performance', style: 'coaching', color: 'GREEN' },
        { text: 'Explore what\'s really going on beneath the defensiveness', style: 'coaching', color: 'YELLOW' },
        { text: 'Suggest taking a break to cool down and reschedule', style: 'affiliative', color: 'BLUE' }
      ]
    },
    {
      ...
      type: 'choice',
      options: [
        { text: 'Offer support but maintain performance expectations', style: 'democratic', color: 'YELLOW' },
        { text: 'Give them 6 weeks grace period to address personal issues', style: 'affiliative', color: 'GREEN' },
        { text: 'Refer to HR/EAP, keep performance discussion separate', style: 'authoritative', color: 'BLUE' },
        { text: 'Co-create a recovery plan together', style: 'coaching', color: 'YELLOW' }
      ]
    }
  ],
  ...
  additionalInfo: [
    ...
    },
    {
      label: 'HR guidance',
      type: 'trap',
      content: 'Suggests formal PIP process - may damage relationship unnecessarily'
    }
  ],
  ...
  decisions: [
    ...
    },
    {
      ...
      options: [
        ...
        { text: 'Team workshop - collaboratively decide launch readiness', style: 'affiliative', color: 'YELLOW' }
      ]
    },
    {
...
// SCENARIO 6: THE YEAR-END RECKONING
{
  ...
  decisions: [
    {
      title: 'Part 0: Reflecting on Your Year - What was your most important learning?',
      type: 'choice',
      options: [
        { text: 'I should have been more decisive from day one', style: 'pacesetting', color: 'RED' },
        { text: 'I should have listened to my team more', style: 'coaching', color: 'GREEN' },
        { text: 'I should have pushed harder for results', style: 'pacesetting', color: 'RED' },
        { text: 'I learned to adapt my approach based on what each situation needed', style: 'coaching', color: 'GREEN' }
      ]
    },
    {
    ...
    {
      title: 'Part 3: Board Strategy - Year 2 Proposal',
      type: 'choice',
      options: [
